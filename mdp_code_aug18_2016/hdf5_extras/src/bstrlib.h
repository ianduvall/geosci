...
extern int bseof (const struct bStream * s);
  ...
  /*! \struct tagbstring
The tagbstring structure represents the bstring datatype that is used to have
safe strings. The string is stored as a standard C string, named \c data.
The length of the string is stored as the item \c slen, while the allocated size
of \c data is stored in the item \c mlen.
   */
struct tagbstring {
	int mlen;
	int slen;
...
# define bsStatic(q)        bsStaticMlen(q,-__LINE__)
  ...
  /* added by LEP: July 27, 2014: syntactically nicer version of above: */
