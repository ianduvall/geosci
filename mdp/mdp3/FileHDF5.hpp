...
*/	
    ...
    class FileHDF5: public H5::H5File {
 ...
 public:
  ...
  //FileHDF5();
    ...
    */
    //lep//static bool isGeoSciHDF5File(std::string filename);
  ...
  */
    //static FileHDF5 *create(std::string name);

        FileHDF5 (const std::string &name, unsigned int flags);
  ...
  */
  //lep//static void destroy(std::string name);
  ...
  */
    //lep//static FileHDF5 *open(std::string name, std::string access);
  ...
  */
  ...
  //lep//ImageHDF5 *create_image(std::string name);
  //lep//ImageHDF5 *open_image(std::string name, std::string access);
  //lep//void       destroy_image(std::string name);
